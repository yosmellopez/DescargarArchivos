Ext.define('Descarga.controller.DescargaControl', {
    extend: 'Ext.app.Controller',
    views: ['descarga.NuevaDescarga', 'descarga.GridDescarga'],
    stores: ['Descargas'],
    models: ['Descarga'],
    refs: [{
            ref: 'grid',
    ...
    init: function () {
        Ext.create('Descarga.store.Descargas', {
            autoLoad: false,
            storeId: 'storeTemp'
        });
        this.control({
            'gridDescarga button[action=nuevo]': {
                click: this.nuevo
            },
            'gridDescarga button[action=modificar]': {
                click: this.modificarBoton
            },
            'nuevaDescarga button[action=insertar]': {
                click: this.insertar
            },
            'nuevaDescarga': {
                close: function () {
